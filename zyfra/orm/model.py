...
class Model(object):
    ...
    def set_column_instance(self, name, col):
        ...
        for name, column in col.needed_columns.items():
    ...
    def help(self):
        ...
        for col_name in col_names:
            ...
            label = col_obj.label
            if hasattr(col_obj, 'select') and col_obj.select is not None:
            ...
            stored = col_obj.stored and 'yes' or 'no'
            table.append([col_name, col_type, label, stored, repr(col_obj.get_default())])
        tools.print_table(table, ['Name', 'Type', 'Description', 'Stored', 'Default value'])
